...
(function (App) {
  ...
  App.elementsCommunicationLayer.prototype.handleElements = function () {
    ...
    window.addEventListener("message", ({ data }) => {
      ...
      if (data.target === "traekElements" && data.action === "RemoveIframe") {
        let elementIframe = document.querySelector(`iframe[id='${data.elementId}']`);
  ...
  App.elementsCommunicationLayer.prototype.elementPlacementHandler = function (element) {
  ...
  App.elementsCommunicationLayer.prototype.findAndStyleIframe = function (data) {
...
new Traek.elementsCommunicationLayer(Traek.TraekAnalytics.currentObject).handleElements();
