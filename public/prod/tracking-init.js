...
(function (App) {
          ...
          form.onsubmit = function (e) {
            formSubmitted(e, form, localThis, () => {
              ...
              saveSessionRecording({
                propertyId: localThis.propertyId,
                userKey: localThis.userKey,
                sessionKey: localThis.sessionKey,
                hostUrl: localThis.hostUrl,
              });
            });
          };
        });
      ...
      .then(({ realtime, property_id, verified, shouldAllowLead, chat_widget, forms, website_url, type, heatmaps }) => {
        ...
        if (property_id && verified === true) {
          ...
          if (realtime) {
            ...
            realtimeSctipt.src = this.cdnUrl + "/realtime.js";
            realtimeSctipt.type = "text/javascript";
            console.log('realtimeSctipt => ', realtimeSctipt);
  ...
  App.TraekAnalytics.prototype.getElementsData = async function () {
    ...
    try {
      ...
      elementsScript.src = this.cdnUrl + "/elements.js";
...
const traek = new Traek.TraekAnalytics(apiKey, "http://localhost:4200", `${window.location.origin}/prod`).trackUserData();
